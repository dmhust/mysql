...
SET(CMAKE_SOURCE_DIR "E:/Git/mysql-5.5.20")
SET(CMAKE_CURRENT_BINARY_DIR "E:/Git/mysql-5.5.20/sql")
SET(MYSQLD_EXECUTABLE "E:/Git/mysql-5.5.20/sql/$(OutDir)/mysqld.exe")
...
EXECUTE_PROCESS(
  COMMAND "C:/Program Files/CMake 2.8/bin/cmake.exe" -E echo Executing ${BOOTSTRAP_COMMAND}
)
EXECUTE_PROCESS (
  COMMAND "C:/Program Files/CMake 2.8/bin/cmake.exe" -E echo input file bootstrap.sql, current directory ${CWD}
)
EXECUTE_PROCESS (  
